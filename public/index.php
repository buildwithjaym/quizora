  ...
  <section class="card">
    <div class="card__pad">
      ...
      <p class="card__subtitle">
        <?php echo e(APP_NAME); ?> is an offline-friendly quiz platform for teachers and students.
      ...
      <?php if (function_exists('teacher_is_logged_in') && teacher_is_logged_in()) { ?>
        <a class="btn btn--primary" href="./../public/teacher_dashboard.php">Go to Dashboard</a>
      <?php } else { ?>
        <div style="display:flex; gap:10px; flex-wrap:wrap;">
          <a class="btn btn--primary" href="./../public/register.php">Teacher Register</a>
          <a class="btn btn--ghost" href="./../public/login.php">Teacher Login</a>
        </div>
      <?php } ?>
      ...
      <form class="form" method="get" action="<?php echo e(BASE_URL); ?>/join.php" autocomplete="off">
        <div class="field">
          ...
          <input
            ...
            id="code"
            name="code"
            maxlength="<?php echo e((string)QUIZ_CODE_LEN); ?>"
            placeholder="e.g., A1B2C3"
            required
          >
          <div class="help">Codes are <?php echo e((string)QUIZ_CODE_LEN); ?> characters. Ask your teacher for the code or link.</div>
        </div>
    ...
    <div class="card__pad">
      ...
      <div class="stack">
        ...
        <div>
          ...
          <div class="help"><?php echo e(APP_NAME); ?> generates a unique <?php echo e((string)QUIZ_CODE_LEN); ?>-character quiz code and link.</div>
        </div>
